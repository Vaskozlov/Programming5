...
public record Location(
    ...
    public Location {
        if (z == null) {
            throw new IllegalArgumentException("OrganizationDatabase.Location() z must not be null");
        }

        if (name != null && name.length() > 933) {
            throw new IllegalArgumentException("OrganizationDatabase.Location() name is too long! It can not contain more than than 933 symbols.");
        }
    }
